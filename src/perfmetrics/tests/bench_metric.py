...
def bench_call_func_without_metric(loops):
...
def bench_call_method_without_metric(loops):
...
##
def bench_call_sampled_func_with_null_client(loops):
    return _bench_call_func_with_client(loops, func_with_metricsampled, null_client)
